...
import LaptopImage from "../../../../images/plan_etaje/c2/plan_1.png";
...
const C2Etaj1 = () => {
  ...
  const handleClick2 = () => {
    history.push("/apartamente/C2/47");
    history.go(0);
  };

  const handleTouch = () => {
    setTimeout(() => {
      history.push("/apartamente/47");
    }, 1200);
  };
  const handleClick = () => {
    history.push("/apartamente/48");
    history.go(0);
  };
