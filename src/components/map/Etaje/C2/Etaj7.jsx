...
import LaptopImage from "../../../../images/plan_etaje/c2/plan_7.png";
...
const C2Etaj7 = () => {
  ...
  const handleClick5 = () => {
    history.push("/apartamente/87");
    history.go(0);
  };

  const handleTouch5 = () => {
    setTimeout(() => {
      history.push("/apartamente/88");
    }, 1200);
  };
  const handleClick6 = () => {
    history.push("/apartamente/88");
